    ...
    <div className="pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          <motion.div {...fadeInUp}>
            <h2 className="text-sm font-bold text-bhs-brown tracking-widest uppercase mb-3">Our Journey</h2>
            <h3 className="text-4xl font-bold text-gray-900 mb-6 leading-tight">
              A Legacy of <span className="text-bhs-green">Qualitative Education</span>
            </h3>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div 
            {...fadeInUp}
            className="bg-bhs-beige/20 p-10 rounded-3xl border border-bhs-beige/50"
          >
          ...
          <motion.div 
            ...
            className="bg-bhs-green/5 p-10 rounded-3xl border border-bhs-green/10"
          >
